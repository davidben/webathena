...
test("RFC 3961 n-fold test vectors", function() {
    ...
    arraysEqual(kcrypto.nFold(56, afbs("password")),
                hexToBytes("78a07b6caf85fa"));
    arraysEqual(kcrypto.nFold(64, afbs("Rough Consensus, and Running Code")),
                hexToBytes("bb6ed30870b7f0e0"));
    arraysEqual(kcrypto.nFold(168, afbs("password")),
                hexToBytes("59e4a8ca7c0385c3c37b3f6d2000247cb6e6bd5b3e"));
    arraysEqual(kcrypto.nFold(192,
                              afbs("MASSACHVSETTS INSTITVTE OF TECHNOLOGY")),
                hexToBytes("db3b0d8f0b061e603282b308a50841229ad798fab9540c1b"));
    arraysEqual(kcrypto.nFold(168, afbs("Q")),
                hexToBytes("518a54a2 15a8452a 518a54a2 15a8452a 518a54a2 15"))
    arraysEqual(kcrypto.nFold(168, afbs("ba")),
                hexToBytes("fb25d531 ae897449 9f52fd92 ea9857c4 ba24cf29 7e"));
    arraysEqual(kcrypto.nFold(64, afbs("kerberos")),
                hexToBytes("6b657262 65726f73"));
    arraysEqual(kcrypto.nFold(128, afbs("kerberos")),
                hexToBytes("6b657262 65726f73 7b9b5b2b 93132b93"));
    arraysEqual(kcrypto.nFold(168, afbs("kerberos")),
...
test("RFC 3962 PBKDF2 test vectors", function() {
    ...
    testStringToKey("password", afbs("ATHENA.MIT.EDUraeburn"), 2,
    ...
    testStringToKey("password", afbs("ATHENA.MIT.EDUraeburn"), 1200,
    ...
    testStringToKey(
        ...
        afbs("pass phrase equals block size"), 1200,
    ...
    testStringToKey(
        ...
        afbs("pass phrase exceeds block size"), 1200,
    ...
    testStringToKey("\uD834\uDD1E", afbs("EXAMPLE.COMpianist"), 50,
